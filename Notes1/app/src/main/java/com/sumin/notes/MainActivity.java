...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for(Note note : notes){
            ...
            contentValues.put(NotesContract.NotesEntry.COLUMN_DAY_OD_WEEK, note.getDayOfWeek());
        ...
        while (cursor.moveToNext()){
            ...
            String dayOfWeek=cursor.getString(cursor.getColumnIndex(NotesContract.NotesEntry.COLUMN_DAY_OD_WEEK));
