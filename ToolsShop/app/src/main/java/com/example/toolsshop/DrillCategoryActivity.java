...
public class DrillCategoryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        drills.add(new Drill(getString(R.string.drill_dewalt_tittle), getString(R.string.drill_dewalt_info),R.drawable.dewalt));
        ...
        listViewDrills.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                intent.putExtra("tittle",drill.getTitle());
